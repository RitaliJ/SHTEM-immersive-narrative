...
export type SurveyType = {title: string, code: string, finalText?: boolean, questions: (ShortAnswerType | MultipleChoiceType)[][]}; //outer array for pages, inner array for questions on that page
