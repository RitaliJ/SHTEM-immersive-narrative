...
export type AccountType = {email: string, firstName: string, lastName: string, phone: string, DOB: DOBType, balance: number, items: ItemType[], purchases: ItemType[], usedCodes: string[], firstVisit: boolean, doneNewsletter: boolean, watchedAd: boolean, target: string};
