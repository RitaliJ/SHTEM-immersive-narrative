        ...
        <>
            ...
            <main className="container flex flex-col gap-3 w-full h-full overflow-y-auto bg-white mb-12">
                ...
                <p>
                    ...
                    protected private information: First and last name, gender, date of birth/ age,
                ...
                <p>
                    ...
                    bring to Disneyland from your family? These corporations have algorithms that can create
                    inferences about you based on the data collected. These inferences indicate your moods
                    and lead to the company having something called a behavioral surplus. Behavioral surplus,
                    coined by Harvard Professor Shoshana Zuboff, is the surplus of data collected far
                    exceeding the amount required to improve products and services. This additional data is
                    used to train models that predict users' behavior and represent their wants, values,
                    interests, and more. With this behavioral surplus, you are the perfect victim for these
                    corporations to release their advertisements, waiting for you to bite. And whether or
                    not you bite is also stored as data and is sold to get a better idea of what type of
                    advertisement and product works for you.`}
                </p>
                <p>
                    ...
                    example. Recent trends indicate a more polarizing America, and one cause of that has to
                ...
                <p>
                    {`Nowadays, our world revolves around our phones. Our interests, Our friends, and Who we
                    see ourselves, are all attached to that small device in your hands. That is the way social
                    media creators want it. Their entire purpose is to see how much of your life you can give
                    to them. They create these predictive algorithms and these addictive features to get you
                    hooked and addicted to your phone. Features like push notifications, beautiful animations,
                    and designs, like buttons, infinite scrolls, and much more are all just pieces in a chess
                    game to capture its king: you. Studies show that the brain of someone addicted to their
                    phone is very much similar to the brain of someone who has a drug or gambling problem. This
                    constant barrage of shallow rewards rewires your brain to want more likes, retweets, and
                    emoji reactions, which leads to social media addiction. It is a never-ending cycle, pulling
                    you in for more and more screen time. Why would they do this? The more time you spend on
                    your phone, the more data they collect from you and the more ads you will be exposed to.
                    The more data that they collect about you, the more companies are willing to spend on that
                    data.`}
                </p>
                <div className="flex justify-center">
                ...
                <p>
                    {`Many services online are offered for free. In the attention economy, attention is not
                    only a resource but a currency: users pay for a service with their attention. For
                    example, while you were using our website for “free”, you didn’t realize you were paying
                    with heartbeats, the limited amount of time you have in your life. Today, the dynamics
                    of the attention economy incentivize companies to draw users in to spend more and more
                    time on apps and sites. This has adverse effects on the user. Once addicted, the less
                    focus and attention they will pay to particular things. They will be less productive
                    and lazy. Studies show that those addicted to social media perform worse on cognitive
                    tests which test the ability to multitask and be attentive. This particularly impacts
                    students. By spending time on social media, they are spending less time on homework or
                    having a social life. Thus, either their grades drop or they rush to finish their
                    homework at the last possible second, evoking feelings of stress. On top of that, a
                    lack of focus and attentiveness can have a terrible impact on a student's learning
                    ability.`}
                </p>
                <div className="flex justify-center">
                ...
                <p>
                    ...
                    that, you have a choice. You can either choose to join the resistance and help stop the
                    growing attention economy or you can continue shopping. This is your choice.
                </p>
                <div className="flex justify-center">
                    <img className="h-96" src="http://www.clipartbest.com/cliparts/9cR/57X/9cR57XMMi.gif" />
                </div>
